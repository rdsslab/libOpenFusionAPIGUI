...
export function getServerAPILastVersion(maxCacheMs?: number): Promise<any>;
...
export function getTraceSummary(options: any): Promise<any>;
export function getTraceErrorsOnly(options: any): Promise<any>;
export function getTraceSlowestHops(options: any): Promise<any>;
